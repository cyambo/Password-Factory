...
//  Password Factory
//
//  Created by Cristiana Yambo on 11/21/17.
...
+ (void)drawPreferencesButtonWithStrokeColor: (NSColor*)strokeColor
{
    ...
    [bezierPath moveToPoint: NSMakePoint(9.5, 6.3)];
    [bezierPath curveToPoint: NSMakePoint(6.3, 9.5) controlPoint1: NSMakePoint(7.74, 6.3) controlPoint2: NSMakePoint(6.3, 7.74)];
    [bezierPath curveToPoint: NSMakePoint(9.5, 12.7) controlPoint1: NSMakePoint(6.3, 11.26) controlPoint2: NSMakePoint(7.74, 12.7)];
    [bezierPath curveToPoint: NSMakePoint(12.7, 9.5) controlPoint1: NSMakePoint(11.26, 12.7) controlPoint2: NSMakePoint(12.7, 11.26)];
    [bezierPath curveToPoint: NSMakePoint(9.5, 6.3) controlPoint1: NSMakePoint(12.7, 7.74) controlPoint2: NSMakePoint(11.26, 6.3)];
    [bezierPath closePath];
    [bezierPath moveToPoint: NSMakePoint(17.78, 8.26)];
    [bezierPath curveToPoint: NSMakePoint(18, 8.59) controlPoint1: NSMakePoint(17.9, 8.31) controlPoint2: NSMakePoint(18, 8.46)];
    [bezierPath lineToPoint: NSMakePoint(18, 10.41)];
    [bezierPath curveToPoint: NSMakePoint(17.78, 10.74) controlPoint1: NSMakePoint(18, 10.54) controlPoint2: NSMakePoint(17.9, 10.69)];
    [bezierPath lineToPoint: NSMakePoint(16.11, 11.41)];
    [bezierPath curveToPoint: NSMakePoint(15.81, 11.72) controlPoint1: NSMakePoint(15.99, 11.46) controlPoint2: NSMakePoint(15.85, 11.6)];
    [bezierPath lineToPoint: NSMakePoint(15.53, 12.39)];
    [bezierPath curveToPoint: NSMakePoint(15.52, 12.82) controlPoint1: NSMakePoint(15.47, 12.51) controlPoint2: NSMakePoint(15.47, 12.7)];
    [bezierPath lineToPoint: NSMakePoint(16.23, 14.48)];
    [bezierPath curveToPoint: NSMakePoint(16.16, 14.86) controlPoint1: NSMakePoint(16.28, 14.6) controlPoint2: NSMakePoint(16.25, 14.77)];
    [bezierPath lineToPoint: NSMakePoint(14.86, 16.16)];
    [bezierPath curveToPoint: NSMakePoint(14.48, 16.23) controlPoint1: NSMakePoint(14.77, 16.25) controlPoint2: NSMakePoint(14.6, 16.28)];
    [bezierPath lineToPoint: NSMakePoint(12.82, 15.52)];
    [bezierPath curveToPoint: NSMakePoint(12.39, 15.53) controlPoint1: NSMakePoint(12.7, 15.47) controlPoint2: NSMakePoint(12.51, 15.47)];
    [bezierPath lineToPoint: NSMakePoint(11.72, 15.81)];
    [bezierPath curveToPoint: NSMakePoint(11.41, 16.11) controlPoint1: NSMakePoint(11.6, 15.85) controlPoint2: NSMakePoint(11.46, 15.99)];
    [bezierPath lineToPoint: NSMakePoint(10.74, 17.78)];
    [bezierPath curveToPoint: NSMakePoint(10.41, 18) controlPoint1: NSMakePoint(10.69, 17.9) controlPoint2: NSMakePoint(10.54, 18)];
    [bezierPath lineToPoint: NSMakePoint(8.59, 18)];
    [bezierPath curveToPoint: NSMakePoint(8.26, 17.78) controlPoint1: NSMakePoint(8.46, 18) controlPoint2: NSMakePoint(8.31, 17.9)];
    [bezierPath lineToPoint: NSMakePoint(7.59, 16.11)];
    [bezierPath curveToPoint: NSMakePoint(7.28, 15.81) controlPoint1: NSMakePoint(7.54, 15.99) controlPoint2: NSMakePoint(7.4, 15.85)];
    [bezierPath lineToPoint: NSMakePoint(6.61, 15.53)];
    [bezierPath curveToPoint: NSMakePoint(6.18, 15.52) controlPoint1: NSMakePoint(6.49, 15.47) controlPoint2: NSMakePoint(6.3, 15.47)];
    [bezierPath lineToPoint: NSMakePoint(4.52, 16.23)];
    [bezierPath curveToPoint: NSMakePoint(4.14, 16.16) controlPoint1: NSMakePoint(4.4, 16.28) controlPoint2: NSMakePoint(4.23, 16.25)];
    [bezierPath lineToPoint: NSMakePoint(2.84, 14.86)];
    [bezierPath curveToPoint: NSMakePoint(2.77, 14.48) controlPoint1: NSMakePoint(2.75, 14.77) controlPoint2: NSMakePoint(2.72, 14.6)];
    [bezierPath lineToPoint: NSMakePoint(3.48, 12.82)];
    [bezierPath curveToPoint: NSMakePoint(3.47, 12.39) controlPoint1: NSMakePoint(3.53, 12.7) controlPoint2: NSMakePoint(3.53, 12.51)];
    [bezierPath lineToPoint: NSMakePoint(3.19, 11.72)];
    [bezierPath curveToPoint: NSMakePoint(2.89, 11.41) controlPoint1: NSMakePoint(3.15, 11.6) controlPoint2: NSMakePoint(3.01, 11.46)];
    [bezierPath lineToPoint: NSMakePoint(1.22, 10.74)];
    [bezierPath curveToPoint: NSMakePoint(1, 10.41) controlPoint1: NSMakePoint(1.1, 10.69) controlPoint2: NSMakePoint(1, 10.54)];
    [bezierPath lineToPoint: NSMakePoint(1, 8.59)];
    [bezierPath curveToPoint: NSMakePoint(1.22, 8.26) controlPoint1: NSMakePoint(1, 8.46) controlPoint2: NSMakePoint(1.1, 8.31)];
    [bezierPath lineToPoint: NSMakePoint(2.89, 7.59)];
    [bezierPath curveToPoint: NSMakePoint(3.19, 7.28) controlPoint1: NSMakePoint(3.01, 7.54) controlPoint2: NSMakePoint(3.15, 7.4)];
    [bezierPath lineToPoint: NSMakePoint(3.47, 6.61)];
    [bezierPath curveToPoint: NSMakePoint(3.48, 6.18) controlPoint1: NSMakePoint(3.53, 6.49) controlPoint2: NSMakePoint(3.53, 6.3)];
    [bezierPath lineToPoint: NSMakePoint(2.77, 4.52)];
    [bezierPath curveToPoint: NSMakePoint(2.84, 4.14) controlPoint1: NSMakePoint(2.72, 4.4) controlPoint2: NSMakePoint(2.75, 4.23)];
    [bezierPath lineToPoint: NSMakePoint(4.14, 2.84)];
    [bezierPath curveToPoint: NSMakePoint(4.52, 2.77) controlPoint1: NSMakePoint(4.23, 2.75) controlPoint2: NSMakePoint(4.4, 2.72)];
    [bezierPath lineToPoint: NSMakePoint(6.18, 3.48)];
    [bezierPath curveToPoint: NSMakePoint(6.61, 3.47) controlPoint1: NSMakePoint(6.3, 3.53) controlPoint2: NSMakePoint(6.49, 3.53)];
    [bezierPath lineToPoint: NSMakePoint(7.28, 3.19)];
    [bezierPath curveToPoint: NSMakePoint(7.59, 2.89) controlPoint1: NSMakePoint(7.4, 3.15) controlPoint2: NSMakePoint(7.54, 3.01)];
    [bezierPath lineToPoint: NSMakePoint(8.26, 1.22)];
    [bezierPath curveToPoint: NSMakePoint(8.59, 1) controlPoint1: NSMakePoint(8.31, 1.1) controlPoint2: NSMakePoint(8.46, 1)];
    [bezierPath lineToPoint: NSMakePoint(10.41, 1)];
    [bezierPath curveToPoint: NSMakePoint(10.74, 1.22) controlPoint1: NSMakePoint(10.54, 1) controlPoint2: NSMakePoint(10.69, 1.1)];
    [bezierPath lineToPoint: NSMakePoint(11.41, 2.89)];
    [bezierPath curveToPoint: NSMakePoint(11.72, 3.19) controlPoint1: NSMakePoint(11.46, 3.01) controlPoint2: NSMakePoint(11.6, 3.15)];
    [bezierPath lineToPoint: NSMakePoint(12.39, 3.47)];
    [bezierPath curveToPoint: NSMakePoint(12.82, 3.48) controlPoint1: NSMakePoint(12.51, 3.53) controlPoint2: NSMakePoint(12.7, 3.53)];
    [bezierPath lineToPoint: NSMakePoint(14.48, 2.77)];
    [bezierPath curveToPoint: NSMakePoint(14.86, 2.84) controlPoint1: NSMakePoint(14.6, 2.72) controlPoint2: NSMakePoint(14.77, 2.75)];
    [bezierPath lineToPoint: NSMakePoint(16.16, 4.14)];
    [bezierPath curveToPoint: NSMakePoint(16.23, 4.52) controlPoint1: NSMakePoint(16.25, 4.23) controlPoint2: NSMakePoint(16.28, 4.4)];
    [bezierPath lineToPoint: NSMakePoint(15.52, 6.18)];
    [bezierPath curveToPoint: NSMakePoint(15.53, 6.61) controlPoint1: NSMakePoint(15.47, 6.3) controlPoint2: NSMakePoint(15.47, 6.49)];
    [bezierPath lineToPoint: NSMakePoint(15.81, 7.28)];
    [bezierPath curveToPoint: NSMakePoint(16.11, 7.59) controlPoint1: NSMakePoint(15.85, 7.4) controlPoint2: NSMakePoint(15.99, 7.54)];
    [bezierPath lineToPoint: NSMakePoint(17.78, 8.26)];
    [bezierPath closePath];
