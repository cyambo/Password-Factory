...
+ (void)drawPasswordHeaderWithFrame: (NSRect)targetFrame resizing: (StyleKitResizingBehavior)resizing
{
    ...
    //// Color Declarations
    NSColor* transparentStrokeColor = [NSColor colorWithRed: 0 green: 0 blue: 0 alpha: 0.501];
    NSColor* transparentFillColor = [NSColor colorWithRed: 0 green: 0 blue: 0 alpha: 0.5];
    ...
    [transparentStrokeColor setStroke];
...
+ (void)drawPasswordTypeHeaderWithFrame: (NSRect)targetFrame resizing: (StyleKitResizingBehavior)resizing
{
    ...
    NSBezierPath* bezierPath = [NSBezierPath bezierPath];
    [bezierPath moveToPoint: NSMakePoint(16.16, 6.29)];
    [bezierPath lineToPoint: NSMakePoint(10.65, 3.09)];
    [bezierPath lineToPoint: NSMakePoint(10.67, 8.01)];
    [bezierPath lineToPoint: NSMakePoint(10.67, 9.77)];
    [bezierPath lineToPoint: NSMakePoint(16.18, 12.97)];
    [bezierPath lineToPoint: NSMakePoint(16.16, 6.29)];
    [bezierPath closePath];
    [bezierPath moveToPoint: NSMakePoint(3.84, 13.14)];
    [bezierPath lineToPoint: NSMakePoint(9.67, 9.77)];
    [bezierPath lineToPoint: NSMakePoint(9.67, 8.14)];
    [bezierPath lineToPoint: NSMakePoint(9.65, 3.08)];
    [bezierPath lineToPoint: NSMakePoint(3.82, 6.45)];
    [bezierPath lineToPoint: NSMakePoint(3.84, 13.14)];
    [bezierPath closePath];
    [bezierPath moveToPoint: NSMakePoint(9.85, 17.21)];
    [bezierPath lineToPoint: NSMakePoint(15.69, 13.84)];
    [bezierPath lineToPoint: NSMakePoint(15.37, 13.66)];
    [bezierPath lineToPoint: NSMakePoint(10.17, 10.63)];
    [bezierPath lineToPoint: NSMakePoint(6.51, 12.75)];
    [bezierPath lineToPoint: NSMakePoint(4.34, 14)];
    [bezierPath lineToPoint: NSMakePoint(9.85, 17.21)];
    [bezierPath closePath];
    [bezierPath moveToPoint: NSMakePoint(17.18, 13.84)];
    [bezierPath curveToPoint: NSMakePoint(17.15, 13.97) controlPoint1: NSMakePoint(17.18, 13.89) controlPoint2: NSMakePoint(17.16, 13.93)];
    [bezierPath curveToPoint: NSMakePoint(17.12, 14.09) controlPoint1: NSMakePoint(17.14, 14.01) controlPoint2: NSMakePoint(17.14, 14.05)];
    [bezierPath curveToPoint: NSMakePoint(16.93, 14.27) controlPoint1: NSMakePoint(17.07, 14.16) controlPoint2: NSMakePoint(17.01, 14.23)];
    [bezierPath lineToPoint: NSMakePoint(10.1, 18.22)];
    [bezierPath curveToPoint: NSMakePoint(9.6, 18.22) controlPoint1: NSMakePoint(9.95, 18.31) controlPoint2: NSMakePoint(9.75, 18.31)];
    [bezierPath lineToPoint: NSMakePoint(3.09, 14.44)];
    [bezierPath lineToPoint: NSMakePoint(3.09, 14.43)];
    [bezierPath curveToPoint: NSMakePoint(3.09, 14.43) controlPoint1: NSMakePoint(3.09, 14.43) controlPoint2: NSMakePoint(3.09, 14.43)];
    [bezierPath lineToPoint: NSMakePoint(3.09, 14.43)];
    [bezierPath curveToPoint: NSMakePoint(3.02, 14.36) controlPoint1: NSMakePoint(3.06, 14.42) controlPoint2: NSMakePoint(3.04, 14.38)];
    [bezierPath curveToPoint: NSMakePoint(2.91, 14.25) controlPoint1: NSMakePoint(2.98, 14.33) controlPoint2: NSMakePoint(2.93, 14.3)];
    [bezierPath curveToPoint: NSMakePoint(2.87, 14.13) controlPoint1: NSMakePoint(2.88, 14.21) controlPoint2: NSMakePoint(2.88, 14.17)];
    [bezierPath curveToPoint: NSMakePoint(2.84, 14) controlPoint1: NSMakePoint(2.86, 14.09) controlPoint2: NSMakePoint(2.84, 14.05)];
    [bezierPath lineToPoint: NSMakePoint(2.82, 6.16)];
    [bezierPath curveToPoint: NSMakePoint(3.07, 5.73) controlPoint1: NSMakePoint(2.82, 5.98) controlPoint2: NSMakePoint(2.91, 5.82)];
    [bezierPath lineToPoint: NSMakePoint(9.9, 1.78)];
    [bezierPath curveToPoint: NSMakePoint(10.15, 1.72) controlPoint1: NSMakePoint(9.98, 1.74) controlPoint2: NSMakePoint(10.06, 1.72)];
    [bezierPath curveToPoint: NSMakePoint(10.4, 1.78) controlPoint1: NSMakePoint(10.24, 1.72) controlPoint2: NSMakePoint(10.32, 1.74)];
    [bezierPath lineToPoint: NSMakePoint(10.4, 1.78)];
    [bezierPath lineToPoint: NSMakePoint(10.4, 1.78)];
    [bezierPath lineToPoint: NSMakePoint(16.91, 5.57)];
    [bezierPath curveToPoint: NSMakePoint(17.16, 6) controlPoint1: NSMakePoint(17.07, 5.66) controlPoint2: NSMakePoint(17.16, 5.82)];
    [bezierPath lineToPoint: NSMakePoint(17.18, 13.84)];
    [bezierPath lineToPoint: NSMakePoint(17.18, 13.84)];
    [bezierPath closePath];
    [transparentFillColor setFill];
    [bezierPath fill];
