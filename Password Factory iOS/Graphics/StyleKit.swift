...
public class StyleKit : NSObject {
    ...
    @objc dynamic public class func drawStrengthMeter(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 343, height: 150), resizing: ResizingBehavior = .aspectFit, strengthColor: UIColor = UIColor(red: 0.887, green: 0.168, blue: 0.090, alpha: 1.000), strength: CGFloat = 0.25, size: CGSize = CGSize(width: 343, height: 150)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 343, height: 150), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
//        context.scaleBy(x: resizedFrame.width / 343, y: resizedFrame.height / 150)
