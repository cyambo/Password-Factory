...
//  Password Factory
//
//  Created by Cristiana Yambo on 2/8/18.
...
public class StyleKit : NSObject {
    ...
    @objc dynamic public class func drawStrengthMeter(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 500, height: 32), resizing: ResizingBehavior = .aspectFit, strengthColor: UIColor = UIColor(red: 0.887, green: 0.168, blue: 0.090, alpha: 1.000), strength: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 500, height: 32), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 500, y: resizedFrame.height / 32)


        //// Background Drawing
        let backgroundPath = UIBezierPath(rect: CGRect(x: 0, y: 0, width: 500, height: 32))
        ...
        let strengthLevelPath = UIBezierPath(rect: CGRect(x: 0, y: 0, width: 500, height: 32))
